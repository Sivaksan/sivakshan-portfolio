...
export default function Contact() {
    return (
        <section id="contact" className="relative min-h-screen py-20 px-4 bg-cyber-black flex items-center">
            <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="w-24 h-1 bg-cyber-cyan mx-auto mb-12"></div>
                ...
                <div className="space-y-6 mb-12">
                    <a
                        href="mailto:ssivakshan@gmail.com"
                        className="block text-3xl md:text-4xl font-bold text-cyber-cyan hover:text-white transition-colors"
                    >
                        ssivakshan@gmail.com
                    </a>
                    <p className="text-gray-400">Aberdeen, Scotland, UK</p>
                </div>
                ...
                <div className="flex gap-6 justify-center">
                    <a
                        ...
                        className="p-4 border-2 border-cyber-cyan hover:bg-cyber-cyan/10 transition-all"
                    >
